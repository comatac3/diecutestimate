  ...
  <div class="container" id="body">
      ...
      <div class="row" style="border-style: solid; border-width: 0.1px; padding: 5px;">
        ...
        <div class="col-md-4" style="margin-top: auto; margin-bottom: auto;">
            ...
            <form style="margin-top: 30px;" action="addproductsql.php" method="post">
                <div class="form-group row">
                    <label for="inputPassword" class="col-sm-4 col-form-label"> Product Name :</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="paper_name" name="product_name" placeholder="ชื่อสินค้า">
                    </div>
                </div>
                      ...
                      <?php $sql = "SELECT * FROM `process`";
                            ...
                            if ($result->num_rows > 0) {
                              ...
                              while($row = $result->fetch_assoc()) { 
                                ...
                                echo '<input type="checkbox" class="form-check-input" id="process" name="process_id[]" value="'.$row[process_id].'">'.$row[process_name].'<br>';
