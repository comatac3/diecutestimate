...
var zz = 5.2;
var xx = 5.2;
var $width=document.getElementById('xx');
var $height=document.getElementById('yy');
var $width2=document.getElementById('zz');
$width.value=xx;
$height.value=yy;
$width2.value=zz;
...
ctx.arcTo(startx+p-dieline,z+y+z+p+starty+p+dieline ,startx+x-dieline,z+y+starty+z+p+p+dieline, 20);
ctx.arcTo(startx+x+p+dieline,z+y+starty+z+p+p+dieline ,startx+x+p+dieline,z+y+starty+z+p+dieline, 20);
...
ctx.arcTo(startx+p+x-10*gap+z+dieline,z+y+starty+z*0.6+p+dieline,startx+p+x-2*gap+z+dieline,starty+z+y+gap*2+p+dieline, 20);
...
//ctx.arcTo(startx+p+x+z+x+2*gap+10*gap-dieline,starty+p+z+y+0.6*x+dieline,startx+p+x+z+x-2*gap+z-dieline,starty+p+z+y+0.6*z+dieline,20)
ctx.arcTo(startx+p+x+z+x+2*gap+10*gap-dieline,starty+p+z+y+0.6*z+dieline,startx+p+x+z+x-2*gap+z-dieline,starty+p+z+y+0.6*z+dieline,20)
...
ctx.arcTo(startx+p+x+2*gap+5*gap-dieline,starty+z-gap*2-0.6*z+p-dieline,startx+p+x-2*gap+z-dieline,starty+z-gap*2-0.6*z+p-dieline, 20);
ctx.lineTo(startx+p+x+z-dieline,starty+z-gap*2-0.6*z+p-dieline);
ctx.lineTo(startx+p+x+z-dieline,starty+z-gap*2-0.6*z+p-dieline);
ctx.lineTo(startx+p+x+z-dieline,starty+p-dieline)
ctx.arcTo(startx+p+x+z-dieline, starty-dieline,startx+p+x+z+p+x-2*p-dieline, starty-dieline,20);
ctx.lineTo(startx+p+x+z+p+x-2*p-dieline, starty-dieline);
ctx.arcTo( startx+p+x+z+x+dieline,starty-dieline ,startx+p+x+z+x+dieline,starty+p-dieline, 20);
ctx.lineTo(startx+p+x+z+x+dieline,starty+p-dieline);
ctx.lineTo(startx+p+x+z+x+dieline,starty+z+p-2*gap-0.6*z-dieline);
ctx.arcTo(startx+p+x+z+x-2*gap+z-10*gap+dieline,starty+z+p-2*gap-0.6*z-dieline,startx+p+x+z+x+z-2*gap+dieline,starty+p+z-2*gap-dieline,20)
